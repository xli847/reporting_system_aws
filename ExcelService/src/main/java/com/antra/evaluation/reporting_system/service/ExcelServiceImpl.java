...
public class ExcelServiceImpl implements ExcelService {
    ...
    public InputStream getExcelBodyById(String id) throws FileNotFoundException {
        Optional<ExcelFile> fileInfo = excelRepository.findById(id); //getFileById(String id)
...
//            log.error("Error in generateFile()", e);
        ...
        excelRepository.save(fileInfo); //saveFile(ExcelFile file)
    ...
    public List<ExcelFile> getExcelList() {
        return excelRepository.findAll(); //getFiles()
    }

    @Override
    public ExcelFile deleteFile(String id) throws FileNotFoundException {
        Optional<ExcelFile> excelFileOpt = excelRepository.findById(id); //getFileById(String id)
        excelRepository.deleteById(id);  //deleteFile(id);
        if (!excelFileOpt.isPresent()) {
            throw new FileNotFoundException();
        }
        ExcelFile excelFile = excelFileOpt.get();
