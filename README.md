What I have done (Lambda not done):
1. Used the embedded mongoDB instead of hashmap to store Excel Meta info in the ExcelRepositoryImpl.
  I also replaced old ExcelRepository methods with the mongo repository default methods in ExcelServiceImpl.
2. Made some changes in the ExcelServiceImpl class to save the Excel file on the S3 bucket.
